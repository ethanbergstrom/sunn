...
resource "oci_functions_function" "enviroStore" {
  ...
  memory_in_mbs  = "128"
  image = oci_devops_build_run.initial_build_run.delivered_artifacts[index(oci_devops_build_run.initial_build_run.delivered_artifacts.*.output_artifact_name,"EnviroStoreOutput")].image_uri
}
...
resource "oci_functions_function" "enviroRetrieve" {
  ...
  memory_in_mbs  = "128"
  image = oci_devops_build_run.initial_build_run.delivered_artifacts[index(oci_devops_build_run.initial_build_run.delivered_artifacts.*.output_artifact_name,"EnviroRetrieveOutput")].image_uri
}
